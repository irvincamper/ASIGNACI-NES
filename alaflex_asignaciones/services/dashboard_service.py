...
class DashboardService:
    ...
    def get_kpis(self) -> list[dict]:
        ...
        asignados = self.asignaciones.count_total()
        ...
        return [
            ...
            {"title": "Empleados sin objetos", "value": str(sin_asignaciones), "icon": "fa5s.user-times", "color": "#F59E0B"},
    ...
    def get_alerts(self) -> list[dict]:
        ...
        sin_turno = self._count_empleados_sin_campo("turno")
        sin_fecha_ingreso = self._count_empleados_sin_campo("fecha_ingreso")
        return [
            {"text": "Conflictos de estacionamiento por mismo turno.", "value": str(conflictos), "icon": "fa5s.exclamation-triangle", "color": "#E11D48"},
            {"text": "Empleados activos sin objetos asignados.", "value": str(sin_asignaciones), "icon": "fa5s.users", "color": "#0057E7"},
            {"text": "Empleados activos sin turno.", "value": str(sin_turno), "icon": "fa5s.clock", "color": "#F59E0B"},
            {"text": "Empleados activos sin fecha de ingreso.", "value": str(sin_fecha_ingreso), "icon": "fa5s.calendar-alt", "color": "#F59E0B"},
            {"text": "Puestos sin reglas de asignacion.", "value": str(puestos_sin_reglas), "icon": "fa5s.link", "color": "#E11D48"},
    ...
    def _count_empleados_sin_campo(self, campo: str) -> int:
        with get_connection() as connection:
            row = connection.execute(
                ...
                FROM empleados
                WHERE estado = 'Activo'
                  AND ({campo} IS NULL OR TRIM({campo}) = '')
                """
            ).fetchone()
